	...
	: Super(ObjectInitializer)
{
	...
	ProjectileMesh->OnComponentHit.AddDynamic(this, &ATopdownGameProjectile::OnHit);		// set up a notification for when this component hits something
...
void ATopdownGameProjectile::OnHit(AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
